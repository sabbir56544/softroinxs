    ...
    Selectpicker.prototype = {
        ...
        function scroll(scrollTop, init) {
          ...
          for (var i = 0; i < chunkCount; i++) {
            ...
            if (
              currentChunk === undefined &&
              scrollTop <=
                that.selectpicker.current.data[end_of_chunk - 1].position -
      ...
      createLi: function () {
        ...
        if (that.options.showTick || that.multiple) {
          ...
          checkMark.className =
            that.options.iconBase + " " + that.options.tickIcon + " check-mark";
          ...
          if (options.optionContent) {
            ...
            if (options.optionIcon) {
              ...
              optionIconElement.className =
                that.options.iconBase + " " + options.optionIcon;
        ...
        $selectOptions.each(function (index) {
          ...
          if (
            ...
            if (
              ...
              liIndex++;
              mainElements.push(
                generateLI(false, classNames.DIVIDER, optID + "div")
              );
              mainData.push({
                type: "divider",
                optID: optID,
          ...
          if (isOptgroup && thisData.divider !== true) {
            ...
            mainElements.push(
              generateLI(generateA(textElement, optionClass, inline))
            );
            mainData.push({
              content: optionContent || text,
              subtext: subtext,
          ...
          if (option && option.selected) {
            ...
            if (
              ...
              if (
                ...
                subtext =
                  ' <small class="text-muted">' + thisData.subtext + "</small>";
              } else {
                subtext = "";
              }
